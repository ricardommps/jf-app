...
const actionsheetItemStyle = tva({
  base: "w-full flex-row items-center p-3 rounded-sm data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed hover:bg-background-50 active:bg-gray-900 data-[focus=true]:bg-gray-900 web:data-[focus-visible=true]:bg-gray-900 data-[checked=true]:bg-gray-900",
});
