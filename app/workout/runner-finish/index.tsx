        ...
        <Box className="px-4 pt-2">
          <Pressable onPress={() => setModalVisible(true)} className="w-full">
            <Box pointerEvents="none">
              ...
              <Input
                variant="rounded"
                className="border-0 bg-background-50 rounded-md mt-2 w-full"
                size="lg"
              >
                <InputField
                  editable={false}
        ...
        <Box className="px-4 pt-4">
          ...
          >
            <Box pointerEvents="none">
              ...
              <Input
                variant="rounded"
                className="border-0 bg-background-50 rounded-md mt-1 w-full"
                size="lg"
              >
                <InputField
                  editable={false}
